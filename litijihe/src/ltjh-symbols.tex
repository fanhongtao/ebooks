...
\newcommand*\yuanhu[1]{% 圆弧
    \mathord{
        \begin{tikzpicture}
            \node[inner sep=0pt] (a) {$#1$};
            \fill (a.north west)[bend left=25] to (a.north east) [bend right=33] to (a.north west);
        \end{tikzpicture}
    }
}
...
% 面积单位
\newcommand{\pfqm}{\mathord{\text{km}^2}}%平方千米
\newcommand{\pfm}{\mathord{\text{m}^2}}%平方米
\newcommand{\pflm}{\mathord{\text{cm}^2}}%平方厘米
\newcommand{\pfhm}{\mathord{\text{mm}^2}}%平方毫米

% 体积单位
\newcommand{\lfm}{\mathord{\text{m}^3}}%立方米
\newcommand{\lffm}{\mathord{\text{dm}^3}}%立方分米
\newcommand{\lflm}{\mathord{\text{cm}^3}}%立方厘米
\newcommand{\lfhm}{\mathord{\text{mm}^3}}%立方毫米

% 质量单位
\newcommand{\haoke}{\mathord{\text{mg}}}%毫克
\newcommand{\ke}{\mathord{\text{g}}}%克
\newcommand{\qianke}{\mathord{\text{kg}}}%千克

\newcommand{\qkmlfm}{\mathord{\text{kg}/\text{m}^3}}%千克每立方米
\newcommand{\kmlflm}{\mathord{\text{g}/\text{cm}^3}}%克每立方厘米
