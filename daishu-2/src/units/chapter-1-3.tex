...
\begin{xiaoxiaotis}
    ...
    \twoInLineXxt[16em]{$y = \arctan\dfrac{x}{2}$；}{$y = 3\arccot(1 - x)$。} \jiange
...
\begin{xiaoxiaotis}
    ...
    \renewcommand\arraystretch{1.5}
    \begin{tabular}[t]{*{2}{@{}p{16em}}}
        \xiaoxiaoti{$\tan(\arctan 2.84)$；} & \xiaoxiaoti{$\arctan\left( \tan\dfrac{4\pi}{5} \right)$；\jiange} \\
        \xiaoxiaoti{$\cot\left[ \arccot\left( -\dfrac{1}{2} \right)\right]$；} & \xiaoxiaoti{$\arccot\left[ \cot\left( -\dfrac{1}{2} \right)\right]$。\jiange}
    \end{tabular}
