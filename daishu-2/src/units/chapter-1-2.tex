...
\begin{xiaoxiaotis}
    ...
    \jiange
    \xiaoxiaoti{$\sin\left[ \arccos\left( -\dfrac{4}{5} \right)\right]$；\jiange}

    \xiaoxiaoti{$\tan(\arccos x), \; x \in [-1, 1]$，且 $x \neq 0$；\jiange}

    \xiaoxiaoti{$\cos\left[ \arccos\dfrac{4}{5} + \arccos\left( -\dfrac{5}{13} \right)\right]$。\jiange}
...
\begin{xiaoxiaotis}
    ...
    \jiange
    \xiaoxiaoti{$\cos\left( \arccos\dfrac{\sqrt{5}}{3} \right) = \dfrac{\sqrt{5}}{3}$ 是否成立，为什么？}\jiange
...
\begin{xiaoxiaotis}
    ...
    \begin{tabular}[t]{*{2}{@{}p{16em}}}
        ...
        \xiaoxiaoti{$y = \dfrac{1}{2} \arccos\dfrac{x}{4}$；\jiange} & \xiaoxiaoti{$y = 3\arccos(2 - 3x)$。}
    \end{tabular}
...
\begin{xiaoxiaotis}
    ...
    \begin{tabular}[t]{*{2}{@{}p{16em}}}
        ...
        \xiaoxiaoti{$\arccos\left( -\dfrac{3}{4} \right)$；\jiange} & \xiaoxiaoti{$\arccos 0.0471$。}
    \end{tabular}
...
\begin{xiaoxiaotis}
    ...
    \begin{tabular}[t]{*{2}{@{}p{16em}}}
        ...
        \xiaoxiaoti{$\cos\left[ \arccos\left( -\dfrac{1}{4} \right)\right]$；} & \xiaoxiaoti{$\arccos\left[ \cos\left( -\dfrac{1}{4} \right)\right]$。\jiange}
    \end{tabular}
...
\begin{xiaoxiaotis}
    ...
    \begin{tabular}[t]{*{2}{@{}p{16em}}}
        ...
        \xiaoxiaoti{$\sin\left[ \dfrac{\pi}{3} + \arccos\left( -\dfrac{1}{4} \right)\right]$；\jiange} & \xiaoxiaoti{$\cot(\arccos x), \; x \in (-1, 1)$。}
    \end{tabular}
